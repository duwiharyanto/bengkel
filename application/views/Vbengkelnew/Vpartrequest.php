                  ...
                  <td><?php echo $data->qty?></td>
               	  <td align="center"><?php if($data->status==0){echo "<span class=\"label label-danger\">Blm Disetujui</span>";}else{echo "<span class=\"label label-success\">Disetujui</span>";}?></td>
               		<td align="center"><a href="#" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label label-success">Edit</span></a> 
               			 <a href="#" onclick="confirm_modal('<?php echo site_url('Cbengkelnew/Cpartrequest/hapus/').'/'.$data->id ?>')"><span class="label label-danger">Delete</span></a>
               		   <a href="Cpartrequest/aktivasi/<?php echo $data->id ?>/<?php echo $data->status ?>" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label <?php if($data->status==0){echo "label-primary";}else{echo "label-success";}?> ">Aktivasi</span></a>
                  </td>
               	<!--
