<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo site_url('Cbengkelnew/Cdivisi/update');?>" name="modal_popup" enctype="multipart/form-data" method="POST"> 
                ...
                <div class="form-group">
                    <label for="jeniskendaraan">Nama Divisi/Department</label>       
