...
<div class="container-fluid" style="background-color=#ECF0F5">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/Cbengkelnew/Cmasterasset')?>"><i class="fa fa-dashboard"></i> Home</a></li>
                ...
                <tbody>
                  ...
                  <td><?php echo strtoupper($data->kode)?></td>
               		...
               		<td><a href="#" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label label-success">Edit</span></a> 
               			 <a href="#" onclick="confirm_modal('<?php echo site_url('Cbengkelnew/Cmasterasset/hapus/').'/'.$data->id ?>')"><span class="label label-danger">Delete</span></a>
               		</td>
               	<!--
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo site_url('Cbengkelnew/Cmasterasset/simpandata');?>" name="modal_popup" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    <label for="noinventaris">Kode</label>       
                    <input type="text" name="kode"  class="form-control capitalize"  value=""/>
                </div>
                 <div class="form-group">
                    <label for="noinventaris">Jenis Asset</label>       
                    <input type="text" name="jenis"  class="form-control"  value="" style="text-transform:capitalize;" />
                </div>
...
<script type="text/javascript">
   ...
   $(".open_modal").click(function(e) {
      var m =$(this).attr("id");
  		    $.ajax({
    			   //url: "modal_edit.php",
    			   url:"<?php echo site_url('Cbengkelnew/Cmasterasset/edit_data/')?>/"+m,
    			   //type: "GET",
    			   //datatype="JSON",
    			   data: {modal_id: m,},
