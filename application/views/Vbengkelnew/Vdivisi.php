...
<div class="container-fluid" style="background-color=#ECF0F5">
    ...
    <section class="content-header">
      <h1>
        Daftar Divisi/Departmen
        <small>advanced tables</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Daftar Divisi/Departmen</a></li>
        <!--
                ...
                <tbody>
                  ...
                  <td><?php echo $data->kode?></td>
               		...
               		<td><a href="#" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label label-success">Edit</span></a> 
               			 <a href="#" onclick="confirm_modal('<?php echo site_url('Cbengkelnew/Cdivisi/hapus/').'/'.$data->id ?>')"><span class="label label-danger">Delete</span></a>
               		</td>
               	<!--
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo site_url('Cbengkelnew/Cdivisi/simpandata');?>" name="modal_popup" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    <label for="noinventaris">Kode</label>       
                    <input type="text" name="kode"  class="form-control" value="" />
                </div>
                <div class="form-group">
                    <label for="noinventaris">Nama Divisi/Departmen</label>       
...
<script type="text/javascript">
   ...
   $(".open_modal").click(function(e) {
      var m =$(this).attr("id");
  		    $.ajax({
    			   //url: "modal_edit.php",
    			   url:"<?php echo site_url('Cbengkelnew/Cdivisi/edit_data/')?>/"+m,
    			   //type: "GET",
    			   //datatype="JSON",
    			   data: {modal_id: m,},
