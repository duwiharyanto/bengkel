            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  ...
                  <td><?php echo ucwords($data->suplier)?></td>
               		<td align="center"><a href="#" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label label-success">Edit</span></a> 
               			 <a href="#" onclick="confirm_modal('<?php echo site_url('Cbengkelnew/cpart/hapus/').'/'.$data->id ?>')"><span class="label label-danger">Delete</span></a>
               		   <a href="Cpartorder/partorder/<?php echo $data->id ?>" class='open_modal' id='<?php echo  $data->id; ?>'><span class="label label-primary">Order</span>
                  </td>
               	<!--
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo site_url('Cbengkelnew/cpart/simpandata');?>" name="modal_popup" enctype="multipart/form-data" method="POST">
